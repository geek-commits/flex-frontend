...
export const CONSOLE_MODULES: ModuleEntry[] = [
    ...
    { id: 'recordings', href: '/admin/recordings', title: 'Audio & Recordings', description: 'Manage system audio prompts, greetings, IVR recordings, and hold music.', icon: RiDiscLine, category: 'Telephony & Operations', keywords: ['recording', 'audio', 'prompts', 'greetings', 'moh', 'archive'], capability: 'console.view' },
