...
export const CONSOLE_MODULES: ModuleEntry[] = [
    ...
    { id: 'system-settings', href: '/admin/system', title: 'System Settings', description: 'SIP trunks, global environment variables, and mail config.', icon: RiEqualizerLine, category: 'System Configuration', keywords: ['system', 'sip', 'trunk', 'mail', 'smtp', 'email', 'environment'], capability: 'system.view' },
