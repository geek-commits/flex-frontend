...
export const CONSOLE_MODULES: ModuleEntry[] = [
    ...
    { id: 'subscriptions', href: '/admin/subscription', title: 'Subscriptions', description: 'Track subscription status, remaining days, reminders, and renewal activity.', icon: 'subscriptions', category: 'Core Administration', keywords: ['subscription', 'plan', 'billing', 'expiry', 'seats', 'renewal'], capability: 'settings.manage' },
    ...
    { id: 'mail-config', href: '/admin/mail-config', title: 'Mail Configuration', description: 'Configure and test SMTP server settings for system alerts and notifications.', icon: 'mail', category: 'System Configuration', keywords: ['mail', 'smtp', 'email', 'notifications', 'host', 'port'], capability: 'settings.manage' },
