    ...
    return (
        <div className="relative">
            ...
            <button
                ...
                aria-label={showPassword ? t('settings.passwordInput.hide') : t('settings.passwordInput.show')}
                title={showPassword ? t('settings.passwordInput.hide') : t('settings.passwordInput.show')}
                tabIndex={-1}
            >
                {showPassword ? (
